...
settlementAidOfferPage.prototype = Object.create({}, {
    ...
    setTuitionFeesCosts: { value: function (tuition) { return this.tuitionFeesCosts.sendKeys(tuition); } },
    housingMealsCosts: { get: function () { return element(by.id('costs__room-and-board')); } },
    setHousingMealsCosts: { value: function (housing) { return this.housingMealsCosts.sendKeys(housing); } },
    booksSuppliesCosts: { get: function () { return element(by.id('costs__books')); } },
    setBooksSuppliesCosts: { value: function (books) { return this.booksSuppliesCosts.sendKeys(books); } },
    transportationCosts: { get: function () { return element(by.id('costs__transportation')); } },
    setTransportationCosts: { value: function (transportation) { return this.transportationCosts.sendKeys(transportation); } },
    otherEducationCosts: { get: function () { return element(by.id('costs__other')); } },
    setOtherEducationCosts: { value: function (othercosts) { return this.otherEducationCosts.sendKeys(othercosts); } },
    ...
    setFederalPellGrants: { value: function (pellgrant) { return this.federalPellGrants.sendKeys(pellgrant); } },
    ...
    otherGrantsScholarships: { get: function () { return element(by.id('grants__scholarships')); } },
    setOtherGrantsScholarships: { value: function (othergrants) { return this.otherGrantsScholarships.sendKeys(othergrants); } },
    ...
    setStudentContribution: { value: function (studentcontrib) { return this.studentContribution.sendKeys(studentcontrib); } },
    familyContribution: { get: function () { return element(by.id('contrib__family')); } },
    setFamilyContribution: { value: function (familycontrib) { return this.familyContribution.sendKeys(familycontrib); } },
    workStudyContribution: { get: function () { return element(by.id('contrib__workstudy')); } },
    setWorkStudyContribution: { value: function (workstudy) { return this.workStudyContribution.sendKeys(workstudy); } },
    ...
    setFederalPerkinsLoans: { value: function (perkins) { return this.federalPerkinsLoans.sendKeys(perkins); } },
    subsidizedLoans: { get: function () { return element(by.id('contrib__subsidized')); } },
    setSubsidizedLoans: { value: function (subsidized) { return this.subsidizedLoans.sendKeys(subsidized); } },
    unsubsidizedLoans: { get: function () { return element(by.id('contrib__unsubsidized')); } },
    setUnsubsidizedLoans: { value: function (unsubsidized) { return this.unsubsidizedLoans.sendKeys(unsubsidized); } },
    directPLUSLoans: { get: function () { return element(by.id('contrib__direct-plus')); } },
    setDirectPLUSLoans: { value: function (directplus) { return this.directPLUSLoans.sendKeys(directplus); } },
    ...
    setPrivateLoanAmount: { value: function (privateamount) { return this.privateLoanAmount.sendKeys(privateamount); } },
    privateLoanInterestRate: { get: function () { return element(by.id('contrib__private-loan-interest')); } },
    setPrivateLoanInterestRate: { value: function (privateinterest) { return this.privateLoanInterestRate.sendKeys(privateinterest); } },
    privateLoanFees: { get: function () { return element(by.id('contrib__private-loan-fees')); } },
    setPrivateLoanFees: { value: function (privatefees) { return this.privateLoanFees.sendKeys(privatefees); } },
    privateLoanGracePeriod: { get: function () { return element(by.id('contrib__private-loan-grace-period')); } },
    setPrivateLoanGracePeriod: { value: function (privategrace) { return this.privateLoanGracePeriod.sendKeys(privategrace); } },
    ...
    setPaymentPlanAmount: { value: function (paymentamount) { return this.setPaymentPlanAmount.sendKeys(paymentamount); } },
