...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'School.control'
        db.add_column(u'paying_for_college_school', 'control',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'School.control'
        db.delete_column(u'paying_for_college_school', 'control')
