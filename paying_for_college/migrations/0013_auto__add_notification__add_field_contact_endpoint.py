...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'paying_for_college_notification', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('institution', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['paying_for_college.School'])),
            ('oid', self.gf('django.db.models.fields.CharField')(max_length=40)),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')()),
            ('errors', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('email', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
        ))
        db.send_create_signal(u'paying_for_college', ['Notification'])

        # Adding field 'Contact.endpoint'
        db.add_column(u'paying_for_college_contact', 'endpoint',
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'paying_for_college_notification')

        # Deleting field 'Contact.endpoint'
        db.delete_column(u'paying_for_college_contact', 'endpoint')
