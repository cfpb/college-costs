...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'School.grad_rate_4yr'
        db.add_column(u'paying_for_college_school', 'grad_rate_4yr',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=4, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'School.grad_rate_lt4'
        db.add_column(u'paying_for_college_school', 'grad_rate_lt4',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=4, decimal_places=2, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'School.grad_rate_4yr'
        db.delete_column(u'paying_for_college_school', 'grad_rate_4yr')

        # Deleting field 'School.grad_rate_lt4'
        db.delete_column(u'paying_for_college_school', 'grad_rate_lt4')
