...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'School.ope8_id'
        db.alter_column(u'paying_for_college_school', 'ope8_id', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'School.ope6_id'
        db.alter_column(u'paying_for_college_school', 'ope6_id', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'School.ope8_id'
        db.alter_column(u'paying_for_college_school', 'ope8_id', self.gf('django.db.models.fields.CharField')(max_length=8, null=True))

        # Changing field 'School.ope6_id'
        db.alter_column(u'paying_for_college_school', 'ope6_id', self.gf('django.db.models.fields.CharField')(max_length=6, null=True))
