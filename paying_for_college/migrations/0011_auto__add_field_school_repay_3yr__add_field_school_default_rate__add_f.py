...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'School.repay_3yr'
        db.add_column(u'paying_for_college_school', 'repay_3yr',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=13, decimal_places=10, blank=True),
                      keep_default=False)

        # Adding field 'School.default_rate'
        db.add_column(u'paying_for_college_school', 'default_rate',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=4, decimal_places=3, blank=True),
                      keep_default=False)

        # Adding field 'School.median_total_debt'
        db.add_column(u'paying_for_college_school', 'median_total_debt',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=1, blank=True),
                      keep_default=False)

        # Adding field 'School.median_monthly_debt'
        db.add_column(u'paying_for_college_school', 'median_monthly_debt',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=14, decimal_places=9, blank=True),
                      keep_default=False)

        # Adding field 'School.median_annual_pay'
        db.add_column(u'paying_for_college_school', 'median_annual_pay',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'School.repay_3yr'
        db.delete_column(u'paying_for_college_school', 'repay_3yr')

        # Deleting field 'School.default_rate'
        db.delete_column(u'paying_for_college_school', 'default_rate')

        # Deleting field 'School.median_total_debt'
        db.delete_column(u'paying_for_college_school', 'median_total_debt')

        # Deleting field 'School.median_monthly_debt'
        db.delete_column(u'paying_for_college_school', 'median_monthly_debt')

        # Deleting field 'School.median_annual_pay'
        db.delete_column(u'paying_for_college_school', 'median_annual_pay')
