...
from paying_for_college.disclosures.scripts.notifications import retry_notifications

COMMAND_HELP = "Retry_notifications attempts to resend any notifications "
...
"but you can pass a different number of days as an optional '--days' parameter."
